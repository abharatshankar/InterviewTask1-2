...
struct DetailCountry : Codable {
	...
	let currencies : [myCurrencies]?
	let languages : [myLanguages]?
	let translations : myTranslations?
	let flag : String?
	let regionalBlocs : [myRegionalBlocs]?
	let cioc : String?
	...
	init(from decoder: Decoder) throws {
		...
		currencies = try values.decodeIfPresent([myCurrencies].self, forKey: .currencies)
		languages = try values.decodeIfPresent([myLanguages].self, forKey: .languages)
		translations = try values.decodeIfPresent(myTranslations.self, forKey: .translations)
		flag = try values.decodeIfPresent(String.self, forKey: .flag)
		regionalBlocs = try values.decodeIfPresent([myRegionalBlocs].self, forKey: .regionalBlocs)
		cioc = try values.decodeIfPresent(String.self, forKey: .cioc)
	}

}

struct myCurrencies : Codable {
    let code : String?
    let name : String?
    let symbol : String?
...
struct myRegionalBlocs : Codable {
    let acronym : String?
    let name : String?
